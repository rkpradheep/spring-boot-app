...
public enum BuildStates
{
	...
	CHANNEL_MAPPING_FAILED(Constants.CHANNEL_MAPPING_FAILED),
	...
	SD_CSEZ_BUILD_UPDATE(Constants.SD_CSEZ_BUILD_UPDATE),
	SD_CSEZ_BUILD_UPDATE_FAILED(Constants.SD_CSEZ_BUILD_UPDATE_FAILED),
	SD_LOCAL_BUILD_UPDATE(Constants.SD_LOCAL_BUILD_UPDATE),
	SD_LOCAL_BUILD_UPDATE_FAILED(Constants.SD_LOCAL_BUILD_UPDATE_FAILED),
	SD_PRE_BUILD_UPDATE(Constants.SD_PRE_BUILD_UPDATE),
	SD_PRE_BUILD_UPDATE_FAILED(Constants.SD_PRE_BUILD_UPDATE_FAILED);
	...
	public static class Constants
	{
		...
		public static final String CHANNEL_MAPPING_FAILED = "CHANNEL_MAPPING_FAILED";
		...
		public static final String SD_CSEZ_BUILD_UPDATE = "SD_CSEZ_BUILD_UPDATE";
		public static final String SD_CSEZ_BUILD_UPDATE_FAILED = "SD_CSEZ_BUILD_UPDATE_FAILED";
		public static final String SD_LOCAL_BUILD_UPDATE = "SD_LOCAL_BUILD_UPDATE";
		public static final String SD_LOCAL_BUILD_UPDATE_FAILED = "SD_LOCAL_BUILD_UPDATE_FAILED";
		public static final String SD_PRE_BUILD_UPDATE = "SD_PRE_BUILD_UPDATE";
		public static final String SD_PRE_BUILD_UPDATE_FAILED = "SD_PRE_BUILD_UPDATE_FAILED";
	}
}
