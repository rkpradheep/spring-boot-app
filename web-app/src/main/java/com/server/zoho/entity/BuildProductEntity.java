...
public class BuildProductEntity
{
	...
	{
		this.status = BuildProductStatus.BUILD_STARTED.getName();
		this.buildId = buildId;
	...
	{
		this.status = BuildProductStatus.BUILD_SUCCESS.getName();
	...
	{
		this.status = BuildProductStatus.BUILD_FAILED.getName();
		this.errorMessage = errorMessage;
		this.endTime = System.currentTimeMillis();
		if(this.startTime != null)
		{
	...
	{
		this.status = BuildProductStatus.CANCELLED.getName();
		this.endTime = System.currentTimeMillis();
		if(this.startTime != null)
		{
			this.duration = this.endTime - this.startTime;
